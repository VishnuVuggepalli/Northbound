 ...
 */
export type Platform = 'arista' | 'cisco' | 'pica8' | 'mikrotik' | 'mikrotik_swos' | 'freebsd' | 'mock';
 ...
 * a UI-wide rename.
 */
export type PlatformId = 'arista' | 'cisco' | 'pica8' | 'mikrotik' | 'mikrotik_swos' | 'freebsd' | 'mock';
